...
setup(name='ScoPy',
	...
	scripts=['scopy'],
	data_files=[
		('share/applications', ['data/scopy.desktop']),
		('share/glib-2.0/schemas', ['data/apps.scopy.gschema.xml']),
		...
		('share/icons/hicolor/16x16/apps/', ['data/icons/16x16/scopy.png']),
		('share/icons/hicolor/22x22/apps/', ['data/icons/22x22/scopy.png']),
		('share/icons/hicolor/24x24/apps/', ['data/icons/24x24/scopy.png']),
		('share/icons/hicolor/32x32/apps/', ['data/icons/32x32/scopy.png']),
		('share/icons/hicolor/48x48/apps/', ['data/icons/48x48/scopy.png']),
		('share/icons/hicolor/256x256/apps/', ['data/icons/256x256/scopy.png']),
		('share/icons/hicolor/scalable/apps/', ['data/icons/scalable/scopy.svg']),
